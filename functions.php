 ...
 * jacksonchance
 *
 * This file adds functions to the jacksonchance.
 *
 * @package jacksonchance
 * @author  Bloom | Robert McMillin
 * @license GPL-2.0+
 * @link    http://robertmcmillin.com
 */
...
function showcase_theme_setup() {
	...
	define( 'CHILD_THEME_NAME', 'jacksonchance' );
	...
	genesis_register_sidebar( array(
		...
		'description' => __( 'This is the 6th section on the front page', 'showcase' ),
	) );
	
	genesis_register_sidebar( array(
		'id'          => 'front-page-7',
		'name'        => __( 'Front Page 7', 'showcase' ),
		'description' => __( 'This is the 7th section on the front page', 'showcase' ),
	) );
...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Roboto:400,700|Sacramento', false ); 
}
 ...
 */
 ...
 add_action( 'genesis_before_footer', 'front_page_seven_sitewide' );

function front_page_seven_sitewide() {
if ( !is_front_page() && is_active_sidebar( 'front-page-7' ) ):
genesis_widget_area( 'front-page-7', array(
		'before' => '<div id="front-page-7" class="front-page-7 flexible-widget-area"><div class="wrap"><div class="flexible-widgets widget-area' . showcase_widget_area_class( 'front-page-7' ) . '">',
		'after'  => '</div></div></div>',
		) );
endif;
}
